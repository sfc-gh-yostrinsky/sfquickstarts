...
This quickstart uses a companion GitHub repository. You'll create a Snowsight Workspace from this repo, then use the Cortex Code panel to build everything from prompts.
...
> **Note**: Only users with ACCOUNTADMIN privileges can create API integrations.
...
3. In the dialog:
   - **Repository URL**: `https://github.com/Snowflake-Labs/sfguide-declarative-pipelines-dynamic-tables`
   - **API Integration**: Select `dynamic_tables_git_integration`
4. Select **Public repository**
5. Click **Create**

Once complete, you'll see these files in the workspace:
